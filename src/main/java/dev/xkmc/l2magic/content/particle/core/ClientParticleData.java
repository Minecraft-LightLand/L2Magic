...
public record ClientParticleData(
		int life, boolean doCollision, RenderType renderType,
	...
	public static final LMParticleData DEFAULT = new ClientParticleData(
			40, false, RenderType.NORMAL, null,
			new SimpleMotion(DoubleVariable.ZERO, DoubleVariable.ZERO),
			new VanillaParticleSprite(new ResourceLocation("flame"))
	);

	public Vec3 move(Vec3 velocity, Vec3 position) {
